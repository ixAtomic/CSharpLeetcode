...
namespace LeetcodeTestProject.CapitalOneRelatedQuestionsTests;

public class MaxNumElementsInSubsetTests
{
    [Fact]
    public void MaximumLength_InputIs_5_4_1_2_2_Returns3()
    {
        var solution = new MaxNumElementsInSubset();
        int[] nums = { 5, 4, 1, 2, 2 };
    ...
    [Fact]
    public void MaximumLength_thisonefailed_Returns3()
    {
        var solution = new MaxNumElementsInSubset();
    ...
    [Fact]
    public void MaximumLength_stupidbullshit_Returns3()
    {
        var solution = new MaxNumElementsInSubset();
