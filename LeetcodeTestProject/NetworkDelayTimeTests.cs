...
public class NetworkDelayTimeSolutionTests
{
    [Fact]
    public void NetworkDelayTime_CustomCase_ReturnsExpected()
    {
        int[][] times = new int[][]
        {
            new int[] { 2, 1, 1 },
        ...
        var solver = new NetworkDelayTimeSolution();
    ...
    [Fact]
    public void NetworkDelayTime_CustomCaseLong_ReturnsExpected()
    {
